...
# obs vs. imp
par(mfrow=c(3,2))
compare.density(a.out, var = c("GDP_growth_oecd_num_eco"), main= "Observed vs. Imputed Values of GDP Growth")
...
par(mfrow=c(3,2))
Amelia::overimpute(a.out, var = "GDP_growth_oecd_num_eco", main= "Observed vs. Imputed Values of GDP Growth")
...
imputed_eco %>% 
  select(country_text_id, year_0, variable = GDP_growth_oecd_num_eco) %>% 
