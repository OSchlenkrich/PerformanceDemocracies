...
clust5_m3_pr  = DirichReg(ref_Cluster5_Fec ~  pop_size_caus + UKcol_caus + 
                            cons_caus| 1,
                          caus_culture_profiles_data_pr, "alternative")
clust5_m4_pr  = DirichReg(ref_Cluster5_Fec ~  pop_size_caus + UKcol_caus + 
                            union_caus + leftist_caus + cons_caus| 1,
                          caus_culture_profiles_data_pr, "alternative")
...
p1 = odds_ratio_plot(clust5_m4_pr, sign_niveau = 0.05, vars_sel ="union_caus")
p2 = odds_ratio_plot(clust5_m4_pr, sign_niveau = 0.05, vars_sel ="leftist_caus")
p3 = odds_ratio_plot(clust5_m4_pr, sign_niveau = 0.05, vars_sel ="cons_caus")

ggarrange(p1, p2,p3, nrow=3, common.legend=F)
