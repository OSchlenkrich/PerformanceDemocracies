...
tscs_data = performance_all %>% 
  ...
  mutate(dpFKM_5_mb_fEc_bw = mean(FKM_5_mb_fEc, na.rm=T),
         dpFKM_5_mb_Fec_bw = mean(FKM_5_mb_Fec, na.rm=T),
         dpFKM_5_mb_FeC_bw = mean(FKM_5_mb_FeC, na.rm=T),
         dpFKM_5_mb_fEC_bw = mean(FKM_5_mb_fEC, na.rm=T),
         dpFKM_5_mb_FEC_bw = mean(FKM_5_mb_FEC, na.rm=T),
          
         sum_bw = dpFKM_5_mb_fEc_bw + dpFKM_5_mb_Fec_bw + dpFKM_5_mb_FeC_bw + dpFKM_5_mb_fEC_bw + dpFKM_5_mb_FEC_bw,
         dpFKM_5_mb_fEc_bw = dpFKM_5_mb_fEc_bw/sum_bw,
         dpFKM_5_mb_Fec_bw = dpFKM_5_mb_Fec_bw/sum_bw,
         dpFKM_5_mb_FeC_bw = dpFKM_5_mb_FeC_bw/sum_bw,
         dpFKM_5_mb_fEC_bw = dpFKM_5_mb_fEC_bw/sum_bw,
         dpFKM_5_mb_FEC_bw = dpFKM_5_mb_FEC_bw/sum_bw) %>% 
...
# Create List-Data ####
library(easyCODA)
LogRATIOS = LR(a.out_env$imputations[[1]] %>%  select_at(vars(starts_with("dpFKM"))) %>% 
                 mutate_at(vars(starts_with("dpFKM")), funs(zeroadjuster(.))))
...
LogRATIOS = LR(a.out_soc$imputations[[1]] %>%  select_at(vars(starts_with("dpFKM"))) %>% 
     mutate_at(vars(starts_with("dpFKM")), funs(zeroadjuster(.))))
