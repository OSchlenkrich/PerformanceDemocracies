...
mice_data_soc = as.data.frame(tscs_data) %>%
  ...
  # Spatial Correlation %>% 
  left_join(spatial_dv_year(tscs_data, "soc_inequal_soc"), by=c("country_text_id", "year")) %>% 
  left_join(spatial_dv_year(tscs_data, "eco_inequal_soc"), by=c("country_text_id", "year")) %>% 
...
p1 = xyplot(mice_data_soc_trans, "eco_inequal_soc", c("eco_inequal_soc_spatial_ctl")) 
p2 = xyplot(mice_data_soc_trans, "soc_inequal_soc", c("soc_inequal_soc_spatial_ctl")) 
