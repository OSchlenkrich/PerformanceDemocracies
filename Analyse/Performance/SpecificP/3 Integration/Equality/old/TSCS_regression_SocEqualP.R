...
SOC_mpar = test_modelparameters("soc_equal_soc", "soc_equal_soc_wi_lag", socequalsoc_list[1], chains=8)
saveBRMS("SOC_mpar", "Equality")
SOC_mpar = loadBRMS("SOC_mpar", "Equality")


loo_compare(SOC_mpar[[1]][[1]], SOC_mpar[[2]][[1]], SOC_mpar[[3]][[1]], SOC_mpar[[4]][[1]])
