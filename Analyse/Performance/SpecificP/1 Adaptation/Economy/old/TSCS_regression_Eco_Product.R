...
prior_base_prod <- c(set_prior("cauchy(0,5)", class = "sd"),
                     set_prior("cauchy(0,5)", class = "sigma"),
                set_prior("normal(0,100)", class = "Intercept"),
                set_prior("normal(0,100)", class = "b"),
                set_prior("normal(0, 1)", class = "b", coef="productivity_eco_lag"))

prior_base2_prod <- c(set_prior("cauchy(0,5)", class = "sd"),
                      set_prior("cauchy(0,5)", class = "sigma"),
                 set_prior("normal(0,100)", class = "Intercept"),
                 set_prior("normal(0,100)", class = "b"),
                 set_prior("normal(0,1)", class = "b", coef="productivity_eco_lag"),
                 set_prior("normal(0,1)", class = "b", coef="productivity_eco_lag2"))
...
product_mpar = loadBRMS("product_mpar", "Domestic")


loo_compare(product_mpar[[1]][[1]], product_mpar[[2]][[1]], product_mpar[[3]][[1]], product_mpar[[4]][[1]])
