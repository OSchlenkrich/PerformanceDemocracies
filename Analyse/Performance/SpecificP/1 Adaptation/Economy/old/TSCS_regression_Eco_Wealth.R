...
prior_base <- c(set_prior("cauchy(0,5)", class = "sd"),                    
                set_prior("cauchy(0,5)", dpar = "sigma", class="sd"),
...
WEALTH_mpar = loadBRMS("WEALTH_mpar", "Domestic")
...
loo_compare(WEALTH_mpar[[1]][[1]], WEALTH_mpar[[2]][[1]], WEALTH_mpar[[3]][[1]], WEALTH_mpar[[4]][[1]])

plot(WEALTH_mpar[[4]][[1]], pars="Intercept")
