...
cqcluster.stats_mod <- function (d = NULL, clustering, alt.clustering = NULL,
                                 noisecluster = FALSE, 
...
cqcluster.stats12 <- function (d = NULL, clustering, alt.clustering = NULL,
                             noisecluster = FALSE, 
                             silhouette = TRUE, G2 = FALSE, G3 = FALSE, wgap = TRUE, sepindex = TRUE, 
                             sepprob = 0.1, sepwithnoise = TRUE, compareonly = FALSE, 
                             aggregateonly = FALSE,
...
clustatsum <- function(datadist=NULL,clustering,noisecluster=FALSE,
  ...
  outcstat <- cqcluster.stats_mod(datadist,clustering,pamcrit=pamcrit,...)
...
randomclustersim <- function(datadist,datanp=NULL,npstats=FALSE,
  ...
  nnsim <- function(k,g){
    ...
    #    print(gcl)
    grs <- cqcluster.stats_mod(datadist,gcl,nnk=nnk,pamcrit=pamcrit)
    grss <- summary(grs)
...
# for standardisation.
clusterbenchstats_mod <- function(data,G,diss = inherits(data, "dist"),
                              scaling=TRUE, clustermethod,
